...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($inputs['title'])) {
        ...
        $stmt = $pdo->prepare("
            INSERT INTO anime (title, description, genre, thumbnail_url, video_url, episodes, status, added_by)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?)
        ");
        $stmt->execute([
            $inputs['title'],
        ...
        $_SESSION['flash']      = "\"" . $inputs['title'] . "\" has been added to the library!";
...
<head>
    ...
    <title>Add Anime – AniWatch PH</title>
...
<div class="page-wrapper">
    ...
    <div class="form-page">
        <div class="form-card">
            <h2><i class="fa-solid fa-plus-circle"></i> Anime Details</h2>
